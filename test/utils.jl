...
let str = "#=GF CC   (Römling U.  and Galperin M.Y. “Bacterial cellulose\n"
  ...
  @test get_n_words(str, 3) == String["#=GF", "CC", "(Römling U.  and Galperin M.Y. “Bacterial cellulose"]
end

let str = "#=GF CC   not present in all SecA2–SecY2 systems. This family of Asp5 is\n"

  @test get_n_words(str, 3) == String["#=GF", "CC", "not present in all SecA2–SecY2 systems. This family of Asp5 is"]
end
