@testset "Deprecated" begin
    ...
    res_new_buslje =
        buslje09(read_file(msa_file, FASTA); samples = 0, clustering = false, apc = false)
    ...
    @test_deprecated isresidue(res, "1", "A", "ATOM", "1") ==
                     isresidue(res; model = "1", chain = "A", group = "ATOM", residue = "1")
