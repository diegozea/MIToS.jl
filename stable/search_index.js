...

{
    ...
    "category": "type",
    "text": "MSAs are stored as Matrix{Residue}. It\'s possible to use a NamedResidueMatrix as the most simple MSA with sequence identifiers and column names.\n\n\n\n"
},

{
    ...
    "category": "type",
    "text": "An AlignedSequence wraps a NamedResidueMatrix with only 1 row/sequence. The NamedArray stores the sequence name and original column numbers as Strings.\n\n\n\n"
},
...
{
    "location": "MSA_API.html#MIToS.MSA.columnnames-Tuple{NamedArrays.NamedArray{MIToS.MSA.Residue,2,Array{MIToS.MSA.Residue,2},Tuple{DataStructures.OrderedDict{String,Int64},DataStructures.OrderedDict{String,Int64}}}}",
    "page": "MSA",
...

{
    ...
    "category": "method",
    "text": "namedmatrix returns the NamedResidueMatrix stored in an MSA or aligned sequence.\n\n\n\n"
},
...
{
    "location": "MSA_API.html#MIToS.MSA.sequencenames-Tuple{NamedArrays.NamedArray{MIToS.MSA.Residue,2,Array{MIToS.MSA.Residue,2},Tuple{DataStructures.OrderedDict{String,Int64},DataStructures.OrderedDict{String,Int64}}}}",
    "page": "MSA",
